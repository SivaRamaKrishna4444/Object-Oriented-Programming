...
class polynomial{
    ...
    public:
        polynomial (int a , int b , int c){
            ...
            cout<<"New Polynommial has been created: "<<a<<"x^2 + "<<b<<"x + "<<c<<endl;
        }
        ...
        void get_details(void){
            cout<<"Polynommial value is: "<<this->arr[0]<<"x^2 + "<<this->arr[1]<<"x + "<<this->arr[2]<<endl;
        }

        ~polynomial(){
            delete[] arr;
            cout<<"Destructor has been cancelled out"<<endl;
        }
